...
if (isset($_POST["category"])) {
	...
	if (mysqli_num_rows($run_query) > 0) {
		while ($row = mysqli_fetch_array($run_query)) {
			...
			echo "<li><a href='#' class='selectCategory' cid='$cid'>$cat_name</a></li>";
			// </li>';
		}
		echo "</div>";
	}
		...
		if (mysqli_num_rows($query) > 0) {
			...
			if (!isset($_SESSION["uid"])) {
				...
				echo '<input type="hidden" name="return" value="http://localhost/project1/payment_success.php"/>
									...
									<a href="payment.php"><button type="button" style="
            ...
            border-radius: 4px;
            transition: background-color 0.3s ease;">Payment</button></a>
