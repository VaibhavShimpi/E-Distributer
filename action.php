...
if (isset($_POST["category"])) {
	...
	echo "<div class='container' style='margin:50px 0px'>
	<div class='row'>
		<div class='col-md-12'>
			<ul class='list-style' style='list-style:none; display: inline '>";
	if (mysqli_num_rows($run_query) > 0) {
		while ($row = mysqli_fetch_array($run_query)) {
			...
			text-align: center; height: 50px;">Ladies Wear</p>
			...
			if (!isset($_SESSION["uid"])) {
				...
				echo '</form>
						<form action="https://www.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="business" value="shoppingcart@E-Distributer.com">
				...
				echo '<input type="hidden" name="return" value="http://localhost/project1/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/E-Distributer/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/E-Distributer/cancel.php"/>
									<input type="hidden" name="currency_code" value="USD"/>
									<input type="hidden" name="custom" value="' . $_SESSION["uid"] . '"/>
									<input style="float:right;margin-right:80px;" type="image" name="submit"
								        src="https://www.paypalobjects.com/webstatic/en_US/i.btn/png/blue-rect-paypalcheckout-60px.png" alt="paypalcheckout"
